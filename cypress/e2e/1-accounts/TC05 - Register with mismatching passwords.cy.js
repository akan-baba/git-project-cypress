...
describe('User Registration', () => {
    it('Registration Page', () => {
        ...
        userRegistration.pageActions.enterConfirmPassword().type('re234')
        userRegistration.pageActions.clickConsent().click()
        userRegistration.pageActions.clickRegisterButton().click()
        cy.get('#ConfirmPassword-error').should('be.visible', 'The password and confirmation password do not match.')
